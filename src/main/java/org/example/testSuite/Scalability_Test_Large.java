...
/**
 * Scalability Test Large — 100 VMs, 10 waves of 1000 pods each (10000 total).
 * All homogeneous. Purpose: validate COUBES at doubled scale.
 */
public class Scalability_Test_Large {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Log.printLine("========== Scalability_Test_Large Results ==========");
        ...
        Log.printlnConcat("Completed: ", succeeded, " succeeded, ", failed, " failed (of 10000 total)");
        Log.printLine("");
        ...
        Log.printLine("\nScalability_Test_Large finished!");
    }
}
