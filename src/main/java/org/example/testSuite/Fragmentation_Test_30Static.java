 ...
 * dynamically.
 */
public class Fragmentation_Test_30Static {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PowerModelSpec powerSpec = new PowerModelSpec(500, 0.30);
...
//					"C:\\Users\\flori\\Desktop");
	...
	private static PowerDatacenterCustom createDatacenter(String name){
        ...
        PowerModel powerModelHigh = new PowerModelLinear(500,0.30);  // 500 watts max
        for(int x = 0; x < 5; x++){
            hostList.add(
                    new PowerHost(
                            hostId++,
